...
from vision_text_mas.direct_hf_ablation_presets import AblationName, build_ablation_preset
...
def run(
    variant: Annotated[AblationName, typer.Option(
        "--variant",
        help="base, pruning, pruning_v2, pruning_v3, pruning_v3_reallocation, pruning_v4, pruning_v5, pruning_v6, reallocation, reallocation_v2, pathology_reallocation, pathology_context_reallocation, latent_kv_relay, or both",
    )],
    ...
    patch_budget: Annotated[
        Literal[8, 25], typer.Option("--patch-budget")
    ] = 8,
