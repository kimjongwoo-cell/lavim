...
from vision_text_mas.navigation.onepass_navigation_details import materialize_x20_patches
from vision_text_mas.navigation.onepass_navigation_roots import (
    RootGrid,
