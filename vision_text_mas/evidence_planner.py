...
from vision_text_mas.navigation_contracts import ScalePlan
...
def _fallback_evidence_plan(
    *,
    question: str,
    patch_budget: Literal[5, 8, 12, 20, 25],
) -> EvidencePlan:
    ...
    match patch_budget:
        ...
        case 20:
            overview_count = 4
            detail_count = 16
            detail_anchor_count = 4
        case 12:
            overview_count = 4
            detail_count = 8
            detail_anchor_count = 4
        case _:
            msg = "patch_budget must be 5, 8, 12, 20, or 25"
