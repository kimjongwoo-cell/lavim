...
gpu="${1:?usage: $0 GPU DATASET VARIANT RANGE OUTPUT_ROOT}"
dataset="${2:?usage: $0 GPU DATASET VARIANT RANGE OUTPUT_ROOT}"
variant="${3:?usage: $0 GPU DATASET VARIANT RANGE OUTPUT_ROOT}"
selection="${4:?usage: $0 GPU DATASET VARIANT RANGE OUTPUT_ROOT}"
output="${5:?usage: $0 GPU DATASET VARIANT RANGE OUTPUT_ROOT}"
