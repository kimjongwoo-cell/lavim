#!/bin/bash
# 0919 dev copy: arms load tmp_hj/nlqp_hooks_dev (attention-mass log test). Use OUTROOT=runs/nav4_nlqp_dev.
...
case $ARM in
  ...
  nlqp_rho) K=$ROOT/nlqp_rho; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=native VLMAS_NLQP_LOG=$ROOT/nlqp_rho/nlqp_shard$SHARD.jsonl" ;;
  nlqp_rho_uniform) K=$ROOT/nlqp_rho_uniform; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=uniform VLMAS_NLQP_LOG=$ROOT/nlqp_rho_uniform/nlqp_shard$SHARD.jsonl" ;;
  nlqp_rho_identity) K=$ROOT/nlqp_rho_identity; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=identity VLMAS_NLQP_LOG=$ROOT/nlqp_rho_identity/nlqp_shard$SHARD.jsonl" ;;
  nlqp_rho_direct) K=$ROOT/nlqp_rho_direct; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=direct VLMAS_NLQP_LOG=$ROOT/nlqp_rho_direct/nlqp_shard$SHARD.jsonl" ;;
  vcdlp_rho) K=$ROOT/vcdlp_rho; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=vcdlp VLMAS_NLQP_LOG=$ROOT/vcdlp_rho/nlqp_shard$SHARD.jsonl" ;;
  vcdlp_rho_check) K=$ROOT/vcdlp_rho_check; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=vcdlp_check VLMAS_NLQP_LOG=$ROOT/vcdlp_rho_check/nlqp_shard$SHARD.jsonl" ;;
  vcdlp_rho_uncentered) K=$ROOT/vcdlp_rho_uncentered; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=vcdlp_uncentered VLMAS_NLQP_LOG=$ROOT/vcdlp_rho_uncentered/nlqp_shard$SHARD.jsonl" ;;
  vcdlp_rho_fast) K=$ROOT/vcdlp_rho_fast; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=vcdlp VLMAS_VCDLP_FAST=1 VLMAS_NLQP_ATTNLOG=0 VLMAS_NLQP_LOG=$ROOT/vcdlp_rho_fast/nlqp_shard$SHARD.jsonl" ;;
  vcdlp_rho_fast_check) K=$ROOT/vcdlp_rho_fast_check; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=vcdlp_check VLMAS_VCDLP_FAST=1 VLMAS_NLQP_ATTNLOG=0 VLMAS_NLQP_LOG=$ROOT/vcdlp_rho_fast_check/nlqp_shard$SHARD.jsonl" ;;
  rfnm_rho) K=$ROOT/rfnm_rho; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=rfnm VLMAS_NLQP_LOG=$ROOT/rfnm_rho/nlqp_shard$SHARD.jsonl" ;;
  rfnm_rho_check) K=$ROOT/rfnm_rho_check; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=rfnm_check VLMAS_NLQP_LOG=$ROOT/rfnm_rho_check/nlqp_shard$SHARD.jsonl" ;;
  rfnm_rho_raw) K=$ROOT/rfnm_rho_raw; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=rfnm_raw VLMAS_NLQP_LOG=$ROOT/rfnm_rho_raw/nlqp_shard$SHARD.jsonl" ;;
  rfnm_g001) K=$ROOT/rfnm_g001; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=rfnm VLMAS_NLQP_GAIN=0.01 VLMAS_NLQP_ATTNLOG=0 VLMAS_NLQP_LOG=$ROOT/rfnm_g001/nlqp_shard$SHARD.jsonl" ;;
  rfnm_g003) K=$ROOT/rfnm_g003; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=rfnm VLMAS_NLQP_GAIN=0.03 VLMAS_NLQP_ATTNLOG=0 VLMAS_NLQP_LOG=$ROOT/rfnm_g003/nlqp_shard$SHARD.jsonl" ;;
  rfnm_g01) K=$ROOT/rfnm_g01; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=rfnm VLMAS_NLQP_GAIN=0.1 VLMAS_NLQP_ATTNLOG=0 VLMAS_NLQP_LOG=$ROOT/rfnm_g01/nlqp_shard$SHARD.jsonl" ;;
  rfnm_g03) K=$ROOT/rfnm_g03; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=rfnm VLMAS_NLQP_GAIN=0.3 VLMAS_NLQP_ATTNLOG=0 VLMAS_NLQP_LOG=$ROOT/rfnm_g03/nlqp_shard$SHARD.jsonl" ;;
  rfnm_ceil) K=$ROOT/rfnm_ceil; HOOKS=$REPO/tmp_hj/nlqp_hooks_dev; ARMENV="VLMAS_C1_QASC=1 VLMAS_C1_SELECT=nova VLMAS_NOVA_KEEP=0.25 VLMAS_C1_META_BRIDGE=1 VLMAS_NOVA_RHO=1 VLMAS_PLAN_LATENT_ONLY=1 VLMAS_NLQP=rfnm VLMAS_NLQP_ATTNLOG=0 VLMAS_NLQP_CEIL=$ROOT/rfnm_ceil/ceil_shard$SHARD.jsonl VLMAS_NLQP_LOG=$ROOT/rfnm_ceil/nlqp_shard$SHARD.jsonl" ;;
...
if [ "$SHARD" = smoke ]; then
  ...
  need_nv=0; { [ "$ARM" = nova ] || [ "$ARM" = nova_fulr ] || [ "$ARM" = glvr_rho ] || [ "$ARM" = glvr_rho_nf ] || [ "$ARM" = glvr_rho_fast ] || { [ "${ARM#nlqp_rho}" != "$ARM" ] || [ "${ARM#vcdlp_rho}" != "$ARM" ] || [ "${ARM#rfnm_}" != "$ARM" ]; }; } && need_nv=$SMOKE_N
  fu=$(grep -c '^\[RNLCR\] case .* mode=fulr applied=True' $o.log); fs=$(grep -c '^\[RNLCR.*SKIP' $o.log); nq=$(grep -c '^\[NLQP\] case .* applied=36/36' $o.log); nqs=$(grep -c '^\[NLQP\] case .* SKIP' $o.log); need_nq=0; { [ "${ARM#nlqp_rho}" != "$ARM" ] || [ "${ARM#vcdlp_rho}" != "$ARM" ] || [ "${ARM#rfnm_}" != "$ARM" ]; } && need_nq=$SMOKE_N
