#!/bin/bash
# 0916 PANDA grade-rule test (VLMAS_ANSWERER_GRADE_RULE=1): decode-fix base, PANDA 20 cases (index%10) (nav3, patch 12, step 10, NO C1/NTRS), greedy decode (same as board base)
...
ids=(); for ((i=0; i<196; i+=10)); do ids+=(--dataset-index "$i"); done
